...
chrome.runtime.onInstalled.addListener(function(deets) {
  ...
  if(deets.reason == 'install') {
    chrome.storage.sync.set({title: 'WayTab', links: tabs.tabs, background: './img/school.jpg', autoHide: false, font: 'default', enableWspn: true, bell2: false, todoDate: 'Tomorrow', startChangeLog: true, elapseForm: 'Time'}, function() {});
